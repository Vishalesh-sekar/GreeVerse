...
# (str) Package name
package.name = greeverse

# (str) Package domain (needed for android/ios packaging)
package.domain = org.vishalesh

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,kv,json,mp3,mp4,pdf,txt
...
requirements = python3,kivy,pillow,pygame,ffpyplayer
